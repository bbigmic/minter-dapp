const contractAddress = "0xfD3F5816b221ce632d1C2103D6FAd21DCf2e8B47"; // Replace with your own contract address
const chain = 'goerli'; // goerli, polygon, or ethereum

const welcome_h1 = "Welcome to the INFINITY CRYPTO NFT Project!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The INFINITY CRYPTO NFT Project is a decentralized, open-source project that aims to demonstrate how to develope and launch your own NFT Collection. Follow step by step on the <a href="https://youtube.com/codestackr"  target="_blank" rel="noopener noreferrer">codeSTACKr</a> YouTube channel.';
